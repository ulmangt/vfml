/* A Bison parser, made from core/fc45.y
   by GNU bison 1.35.  */
...
{
       0,     0,     4,     8,    10,    12,    15,    16,    21,    23,
      25,    28,    30,    34
};
static const short yyrhs[] =
{
      13,     9,    15,     0,    13,    10,    14,     0,    14,     0,
       4,     0,    15,    16,     0,     0,     4,    11,    17,     9,
       0,     5,     0,     6,     0,     7,     4,     0,    18,     0,
      18,    10,     4,     0,     4,     0
};
...
{
  "$", "error", "$undefined.", "tInteger", "tString", "tIgnore", 
  "tContinuous", "tDiscrete", "tEOF", "'.'", "','", "':'", "ExampleSpec", 
  "ClassList", "ClassSpec", "AttributeList", "AttributeSpec", 
  "AttributeInfo", "AttributeValueNameList", 0
};
#endif
...
{
       2,-32768,    -5,-32768,-32768,     2,     3,-32768,    -3,-32768,
      -4,-32768,-32768,-32768,     5,     1,     4,-32768,-32768,     7,
  -32768,    12,    13,-32768
};

static const short yypgoto[] =
{
  -32768,-32768,    10,-32768,-32768,-32768,-32768
};
...
{
      11,    12,    13,    14,     4,     5,     1,     8,    10,    17,
      18,    20,    22,    23,    19,     7
};

static const short yycheck[] =
{
       4,     5,     6,     7,     9,    10,     4,     4,    11,     4,
       9,     4,     0,     0,    10,     5
};
